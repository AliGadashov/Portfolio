...
const About = () => {
    return (
        <section id="ABOUT ME" className="flex flex-col justify-center h-screen gap-8">
            {/* Upper Section */}
            <div className="text-start border-l-2 border-black pl-10 py-6 px-6 relative">
            ...
            <div className="flex flex-row gap-20">
                <div className="flex flex-col gap-8">
                    ...
                    <div>
                        ...
                        <p className="text-xl py-2 text-black">I'm a designer & developer with a passion for web design. I
                            enjoy developing simple, clean and slick websites that provide real value to the end user.
                ...
                <div className="flex flex-col md:flex-row justify-between gap-12 md:w-2/3">
                    {/* Experience */}
                    <div
                        className="experience flex flex-col items-center justify-center px-20 w-full box-border bg-[#FFDB67] text-black font-semibold border-black border z-30">
